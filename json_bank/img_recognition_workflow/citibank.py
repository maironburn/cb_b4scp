...
'img_recognition_workflow_main': [
    ...
    'img_recognition_loop_workflow': [
        {'collection_item_detail': [
            ...
            {'target': 'cmboption', 'action': "click", 'boleto_data': 'product'},

            {'target': 'original_amount', 'action': "fill", 'boleto_data': 'amount'},

            {'target': 'type_of_collection_item_code', 'action': "click"},
            {'target': 'cmboption', 'action': "click", 'boleto_data': 'type_of_collection_item_code'},
            ...
            {'target': 'cmboption', 'action': "click", 'boleto_data': 'collection_item_document_type' },

            {'target': 'allow_divergent', 'action': "click"},
            {'target': 'cmboption', 'action': "click", 'boleto_data': 'allow_divergent'},
